...
if($user_name === ""){
    $errors["user_name"][]="UseraNameが未入力です。";
}
if($mail_address === ""){
  ...
  <body>
    ...
    <?php if(   !empty($errors['usre_name']) ||
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control <?php if( !empty($errors['user_name']) )echo "border-danger text-denger"; ?>" id="name" name="user_name" aria-describedy="emailHelp" value="<?php echo $user_name; ?>">
        </div>
        <div class="mb-3">
    ...
    <?php } else { ?>
        ...
        <div class="mb-3">
            <label for="user_name" class="form-label">user_name</label>
            <input type="text" class="form-control" readonly id="exampleInputName" name="user_name" aria-describedy="emailHelp" value="<?php echo $user_name; ?>">
        </div>
        <div class="mb-3">
            <label for="mail_address" class="form-label">mail_address</label>
